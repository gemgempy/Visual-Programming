...
namespace project
{
    public partial class gen_txt_donasi : Form
    {
        public gen_txt_donasi()
        {
            InitializeComponent();
        }
        ...
        {
            TextWriter writer = new StreamWriter(@"D:\visual program\snoringpaw\donasi.txt");
        ...
        private void gen_txt_donasi_Load(object sender, EventArgs e)
        {
